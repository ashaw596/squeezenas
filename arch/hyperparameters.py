...
def get_cityscapes_hyperparams_small(width_multiplier, num_classes, init_channels=16, mid_channels=128,
                                     skip_output_block_index=8, last_conv_channels=256):
...
def get_cityscapes_hyperparams_large(width_multiplier, num_classes, init_channels=16, mid_channels=160,
                                     final_width_multiplier=1.0, skip_output_block_index=1):
...
def get_cityscapes_hyperparams_xlarge(width_multiplier, num_classes, init_channels=16, mid_channels=160,
